  ...
  //         return Country(
  //           name: country.name,
  //           flag: Assets.images.svg.syriaFlagIcon,
  //           // مسار صورة علم سوريا
  //           code: country.code,
  ...
  //     return Container(
  //     height:kMinInteractiveDimension+PPadding.mainPadding * 1.5,
  //
  //       child: Row(
  //         children: [
  ...
  //                           ? null
  //                           : LocaleKeys.validationInvalidphonenumber.tr();
  //                     }
  ...
  //                     labelText: LocaleKeys.authCountrySample.tr(),
  ...
  //                       fontSize: 11,
  //                     ),
  //                     contentPadding: const EdgeInsets.symmetric(horizontal:  PPadding.mainPadding * 1.5),
  //
  //
  //
  //
