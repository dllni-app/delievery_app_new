...
class NotificationRepositoriesImp
  ...
  @override
  DataResponse<GetAllNotificationResponse> getAllNotification(QueryParams params) async =>
      wrapHandlingException(tryCall: () => _remoteData.getAllNotification(params));

  @override
  DataResponse<void> markNotificationRead(String id) async =>
      wrapHandlingException(tryCall: () => _remoteData.markNotificationRead(id));

  @override
  DataResponse<void> deleteNotification(String id) async =>
      wrapHandlingException(tryCall: () => _remoteData.deleteNotification(id));

  @override
  DataResponse<void> deleteAllNotifications() async =>
      wrapHandlingException(tryCall: () => _remoteData.deleteAllNotifications());
}
