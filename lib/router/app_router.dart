...
import '../features/delivery/presentation/pages/delivery_order_details_page.dart';
...
class RouteName {
  ...
  static const deliveryOrderDetails = 'deliveryOrderDetails';
...
class RouteManager {
  ...
  static Route onGenerateRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case RouteName.deliveryOrderDetails:
        final args = routeSettings.arguments as DeliveryOrderDetailsArgs;
        return MaterialPageRoute(
          builder: (_) => DeliveryOrderDetailsPage(initialOrder: args.order),
        );
